        ...
        <div className='infrastructure-text'>
          ...
          <ul className='infrastructure-ul'>
            <li className='infrastructure-li'>
              <div className='infrastructure-li--img'>
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M22 11C22 17.0747 17.0747 22 11 22C4.92525 22 0 17.0747 0 11C0 4.92433 4.92525 0 11 0C17.0747 0 22 4.92433 22 11" fill="#F59B23"></path>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.27273 6.72727C8.27273 8.25455 9.47273 9.45455 11 9.45455C12.5273 9.45455 13.7273 8.25455 13.7273 6.72727C13.7273 5.2 12.5273 4 11 4C9.47273 4 8.27273 5.2 8.27273 6.72727ZM17 16C17 13.6 15.6364 11.5273 13.6727 10.5455C12.9091 11.0909 11.9818 11.4182 11 11.4182C9.96364 11.4182 9.09091 11.0909 8.32727 10.5455C6.36364 11.5273 5 13.6 5 16H17Z" fill="white"></path>
                </svg>
              </div>
            ...
            <li className='infrastructure-li'>
              <div className='infrastructure-li--img'>
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M22 11C22 17.0747 17.0747 22 11 22C4.92525 22 0 17.0747 0 11C0 4.92433 4.92525 0 11 0C17.0747 0 22 4.92433 22 11" fill="#008CC8"></path>
            ...
            <li className='infrastructure-li'>
              <div className='infrastructure-li--img'>
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M22 11C22 17.0747 17.0747 22 11 22C4.92525 22 0 17.0747 0 11C0 4.92433 4.92525 0 11 0C17.0747 0 22 4.92433 22 11" fill="#E6500F"></path>
            ...
            <div className='about-textBlock'>
              <div className='item-header'>
                <svg width="49" height="48" viewBox="0 0 49 48" fill="#44b3b4" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M12.8987 24V5C12.8987 5 10.0017 3 7.89868 3C5.79564 3 2.89868 5 2.89868 5V24M12.8987 24C12.8987 24 10.0017 22 7.89868 22C5.79564 22 2.89868 24 2.89868 24M12.8987 24V43C12.8987 43 10.0017 41 7.89868 41C5.79564 41 2.89868 43 2.89868 43V24" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></path>
                  ...
                  <path d="M29.8987 24V5C29.8987 5 27.0017 3 24.8987 3C22.7956 3 19.8987 5 19.8987 5V24M29.8987 24C29.8987 24 27.0017 22 24.8987 22C22.7956 22 19.8987 24 19.8987 24M29.8987 24V43C29.8987 43 27.0017 41 24.8987 41C22.7956 41 19.8987 43 19.8987 43V24" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></path>
                  ...
                  <path d="M46.8987 24V5C46.8987 5 44.0017 3 41.8987 3C39.7956 3 36.8987 5 36.8987 5V24M46.8987 24C46.8987 24 44.0017 22 41.8987 22C39.7956 22 36.8987 24 36.8987 24M46.8987 24V43C46.8987 43 44.0017 41 41.8987 41C39.7956 41 36.8987 43 36.8987 43V24" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></path>
                </svg>
              </div>
            ...
            <div className='about-textBlock'>
              <div className='item-header'>
                <svg width="49" height="48" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="4" y="43" width="41" height="4" fill="#FFD764" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></rect>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M40 2H9V43H12V5H37V43H40V2Z" fill="#FAD77A"></path>
                  ...
                  <path d="M24.5 43H27V5H24.5M24.5 43H22V5H24.5M24.5 43V5" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></path>
                  <path d="M3.99996 43H42C42 43 44.1156 40.438 44.9 38.5C45.7084 36.5026 43.6948 33.7052 43.4999 31.5C43.3239 29.5085 45 28 45 28H3.99996C3.99996 28 5.67607 29.5085 5.50005 31.5C5.30514 33.7052 3.29158 36.5026 4.1 38.5C4.88437 40.438 7 43 7 43" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></path>
                  <path d="M14 34H35C35 34 35.6773 36.7407 35.5 38.5C35.3143 40.3431 34 43 34 43H15C15 43 13.6858 40.3431 13.5 38.5C13.3228 36.7407 14 34 14 34Z" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></path>
                  <path d="M24.3163 33.3314C24.3163 33.3314 15.5282 31.3283 16.7366 23.4299C16.7366 23.4299 25.5305 25.4183 24.3163 33.3314Z" fill="#008048" stroke="#2B2E32" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                  <path d="M32.3163 23.429C32.3163 23.429 23.5282 25.432 24.7366 33.3305C24.7366 33.3305 33.5305 31.3421 32.3163 23.429Z" fill="#008048" stroke="#2B2E32" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                  <rect x="14" y="30" width="21" height="4" fill="#DC6914" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></rect>
                  <circle cx="44.5" cy="26.5" r="2.5" fill="#234B9B" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></circle>
                  <circle cx="4.5" cy="26.5" r="2.5" fill="#234B9B" stroke="#2B2E32" stroke-width="1.2" stroke-linejoin="round"></circle>
                </svg>
              </div>
              <div className='about-flat-text'>
                <h5>Террасы</h5>
