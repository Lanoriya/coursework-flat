    ...
    <section className='main-content'>
      <div className='container main-container'>
        ...
        <div className='about-text-mobile'>
          <p>Сочетание лучших решений формирует неповторимый образ идеального для проживания района.</p>
          <p>Места общего пользования, эксплуатируемые кровли, прогулочные зоны, коворкинги и объекты Family-space создаются для того, чтобы соседи становились друзьями.</p>
        </div>
